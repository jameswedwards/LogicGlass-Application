...
class StudentClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_class" do
    assert_difference('StudentClass.count') do
      post student_classes_url, params: { student_class: { class: @student_class.class, description: @student_class.description } }
    end
  ...
  test "should update student_class" do
    patch student_class_url(@student_class), params: { student_class: { class: @student_class.class, description: @student_class.description } }
