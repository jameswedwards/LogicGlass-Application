class Country < ApplicationRecord
  ...
  validates :country_abbreviation, :format => { :with => /\A[a-zA-Z]+\z/, :message => "Only letters allowed. Spaces, numbers, or other characters are not allowed.", :multiline => true }, length: { is: 2 }, :presence => true
end
